...
%global pkg_name dynamixel_hardware_interface
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-dynamixel-hardware-interface
Version:        1.5.1
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Pyo <pyo@robotis.com> - 1.5.1-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Pyo <pyo@robotis.com> - 1.5.1-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Pyo <pyo@robotis.com> - 1.5.1-1
- Autogenerated by Bloom
